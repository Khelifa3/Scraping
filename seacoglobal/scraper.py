...
def getAllUnits():
    ...
    with open("seaco.csv", "r", encoding="utf-8") as f:
        lines = f.readlines()
        csv_numbers = [line.split(";")[0] for line in lines]
    missing = [n for n in chunks if n.upper() not in csv_numbers]
